...
export default function HomePageContent() {
  ...
  let aboutRd = [
    {
      image: (
        <img className="logoSO" src="/image/img-homepage/so-logo2.svg" alt="" />
      ),
      about:
    ...
    {
      image: (
        <img className="logoSO" src="/image/img-homepage/so-logo3.svg" alt="" />
      ),
      about:
    ...
    {
      image: (
        <img className="logoSO" src="/image/img-homepage/so-logo4.svg" alt="" />
      ),
      ...
      <div style={{ boxSizing: "border-box" }}>
        <div className="p40">
          <div className="headerHome">
            <img
              className="img-code1"
              src="/image/img-homepage/illo-code.svg"
              alt=""
            />
            <img
              className="img-code2"
              ...
              <div>
                <div style={{ paddingBottom: "20px" }}>
                  <a href="/">
                    <img
                      className="logoSO"
                      src="/image/img-homepage/logo-stackoverflow.png"
                      alt=""
                    />
                  </a>
                  <img
                    className="imgSO"
                    src="/image/img-homepage/illo-public.svg"
                    alt=""
                  />
                  ...
                  <div>
                    <a className="like-button-1" href="/">
                      Join the community
                    </a>
                  </div>
                  <div>
                    or{" "}
                    <a href="/" style={{ color: "hsl(210,8%,55%)" }}>
                      search content
                    </a>
                  </div>
                </div>
              ...
              <div>
                <div style={{ paddingBottom: "20px" }}>
                  <a href="/">
                    <img
                      className="logoSO"
                      src="/image/img-homepage/teams-logo-compact.png"
                      alt=""
                    />
                  </a>
                  <img
                    className="imgSO"
                    src="/image/img-homepage/illo-teams.svg"
                    alt=""
                  />
                  <h2 className="text-h2">
                  ...
                  >
                    <div>
                      <a className="like-button-2" href="/">
                        For large organizations
                        <span>
                          <FaIndustry style={{ marginLeft: "4px" }} />
                        </span>
                      </a>
                    </div>
                    <div>
                      <a className="like-button-2" href="/">
                        For small teams
                        <span>
                          <BsPeopleFill style={{ marginLeft: "3px" }} />
                        </span>
                      </a>
                    </div>
                  </div>
          ...
          <div className="body4-1">
            <div className="flex-item4-1">
              <img
                ...
                src="/image/img-homepage/illo-question.png"
                alt=""
              />
            </div>
            <div className="flex-item4-2">
              <img
                className="imgForyou"
                src="/image/img-homepage/illo-for-you.png"
                alt=""
              />
            </div>
            <div className="flex-item4-1">
              <img
                className="imgHomesearch"
                src="/image/img-homepage/illo-home-search.png"
                alt=""
              />
            </div>
          </div>
            ...
            <div style={{ paddingTop: "11rem" }}>
              <div style={{ textAlign: "center" }}>
                <div>
                  <img
                    className="imgTeams"
                    src="/image/img-homepage/teams-logo.svg"
                    alt=""
                  />
                </div>
                <div className="text-h2p">
                  <h3>
                    ...
                    discoverable format to <span>unblock your team</span>
                  </h3>
                </div>
                <div>
                  <a className="like-button-2" href="/">
            ...
            <div className="hp-text1 pd-120">
              <div className="hp-flexbox-6">
                ...
                <div className="hp-flex-item6">
                  <div className="bg-wh" style={{ fontSize: "17px" }}>
                    You can save time and money with Stack Overflow for Teams.
                  </div>
                  <div className="hp-flex-item-click">
                    <a href="/">Calculator your ROI</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="hp-text2 pd-120">
              <div className="hp-flexbox-7">
                <div className="hp-flex-item7-1">
                  <img
                    className="hp-flex-item7-img"
                    src="/image/img-homepage/illo-integrations-left.png"
                    alt=""
                  />
                  <div style={{ textAlign: "center" }}>
                    <img
                      className="hp-flex-item7-img-sm"
                      src="/image/img-homepage/microsoft-teams.png"
                      alt=""
                    />
                ...
                <div className="hp-flex-item7-2">
                  ...
                  <div>
                    ...
                    <a href="/">Slack</a> & <a href="/">Microsoft Teams</a> in
                    order to cut down on pings, limit distractions and make the
                  ...
                  <div className="hp-flex-item7-img-allMd">
                    <a href="/">
                      <img
                        className="hp-flex-item7-img-md"
                        src="/image/img-homepage/slack-icon.png"
                        alt=""
                      />
                    </a>
                    <a href="/">
                    ...
                    <a href="/">
                      <img
                        className="hp-flex-item7-img-md"
                        src="/image/img-homepage/github-logo.png"
                        alt=""
                      />
                    </a>
                    <a href="/">
                      <img
                        className="hp-flex-item7-img-md"
                        src="/image/img-homepage/jira-logo.png"
                        alt=""
                      />
                    </a>
                    <a href="/">
                      <img
                        className="hp-flex-item7-img-md"
                        src="/image/img-homepage/okta-logo.png"
                        alt=""
                      />
                    </a>
                  </div>
                ...
                <div className="hp-flex-item7-1">
                  ...
                  <img
                    className="hp-flex-item7-img"
                    src="/image/img-homepage/illo-integrations-right.png"
                    alt=""
                  />
                </div>
              </div>
        ...
        <div className="pd-120 hp-container-7">
          ...
          <div className="hp-container7-a2">
            <a href="/">
              Want to work here? <span>Current job openings</span>
            </a>
          </div>
        </div>
          ...
          <div className="hp-container-8-bg">
            <div className="hp-flexbox-10">
              ...
              <div className="hp-flex-item10-2">
                ...
                <h4 className="hp-flex-item10-h4">
                ...
                <p className="hp-flex-item10-p">
                  ...
                  to
                  <a href="/"> Super User </a>, much of the Stack Exchange
        ...
        <div>
          {backTop && (
            <button className="hp-btn-scroll" onClick={scrollTop}>
              {" "}
